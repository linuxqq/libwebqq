...
class Action(_object):
    ...
    __repr__ = _swig_repr
    def pure(self, *args): return _libwebqqpython.Action_pure(self, *args)
    def calls_pure(self, *args): return _libwebqqpython.Action_calls_pure(self, *args)
    def __init__(self): 
        this = _libwebqqpython.new_Action()
...
def fun(*args):
  return _libwebqqpython.fun(*args)
fun = _libwebqqpython.fun
